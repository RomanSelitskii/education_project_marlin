...
/*
    ...
    Return value: NULL
*/ 
function edit_general_info ($user_id, $name, $job_place, $phone, $address){
    ...
    if(!$user_data['user_id']){
        ...
        $sql = "INSERT INTO `general_information` (`id`, `user_id`, `name`, `job_place`, `phone`, `address`, `status`, `avatar`) VALUES (NULL, :user_id, :name, :job_place, :phone, :address, '', '');";
        ...
        $sql = 'UPDATE general_information SET name = :name, job_place = :job_place, phone = :phone, address = :address WHERE user_id = :user_id;';
