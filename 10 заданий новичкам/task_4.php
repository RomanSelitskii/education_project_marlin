                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="progress progress-sm <? echo $item["progress_class"]; ?>">
                                <div class="progress-bar <? echo $item["area_class"]; ?>" role="progressbar" style="width: <? echo $item["width"]; ?>%;" aria-valuenow="<? echo $item["value_now"]; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
							<?}?>
                            <!--div class="d-flex">
                                Transfered
