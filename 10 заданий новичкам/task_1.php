                        ...
                        <div class="panel-content">
                            <div class="panel-content">
                                <div class="bg-warning-100 border border-warning rounded">
									...
									<?php
									//создать массив
									//задать элементы массива
									$array_list = array("Reports" => "reports file", "Analytics" => "analytics graphs", "Export" => "export download", "Storage" => "storage");
																		
									//вывести элементы массива при помощи цикла foreach
									foreach ($array_list as $key => $value) {
									echo '<li class="list-group-item"><span data-filter-tags="' . $value . '">' . $key . '</span></li>';
									}
									?>
