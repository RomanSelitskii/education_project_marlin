                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
						   ...
						   $workers = [
										[
											"full_name" => "Sunny A. (UI/UX Expert)",
											"first_name" => "Sunny",
											"role" => "Lead Author",
										...
										[
											"full_name" => "Jos K. (ASP.NET Developer)",
											"first_name" => "Jos",
										...
										[
											"full_name" => "Jovanni L. (PHP Developer)",
											"first_name" => "Jovanni",
											"role" => "Partner &amp; Contributor",
											"twitter" => "@lodev09",
										...
										[
											"full_name" => "Roberto R. (Rails Developer)",
											"first_name" => "Roberto",
											"role" => "Partner &amp; Contributor",
											"twitter" => "@sildur",
                           ...
                           <div class="<?php echo $worker["status"] == "banned" ? "banned" : ""; ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="img/demo/authors/<? echo $worker["foto"]?>" alt="<? echo $worker["full_name"]?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                        <? echo $worker["full_name"]?>
                                        <small class="m-0 fw-300">
                                            <? echo $worker["role"]?>
                                        </small>
                                    </h5>
                                    <a href="https://twitter.com/<? echo $worker["twitter"]?>" class="text-info fs-sm" target="_blank"><? echo $worker["twitter"]?></a> -
                                    <a href="https://wrapbootstrap.com/user/<? echo $worker["wrapbootstrap"]?>" class="text-info fs-sm" target="_blank" title="Contact <? echo $worker["first_name"]?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
						   <? } ?>
